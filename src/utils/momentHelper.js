...
function getLocaleDate() {
    let month, date, day;
    let d = new Date();
    month = moment(d).tz(moment.tz.guess()).format("MMMM");
    date = moment(d).tz(moment.tz.guess()).format("Do");
    day = moment(d).tz(moment.tz.guess()).format("dddd");
...
export { toUnix, getLocaleDate, getLocaleFullDateWithTime, getLocaleDateWithYYYY, getLocaleSemiDateWithTime, getLocaleDateWithYMS }
